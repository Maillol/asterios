...
from .schema import ReturnedGameSchema, GameToCreateSchema, ReturnedTeamMemberSchema, TeamMemberToCreateSchema, \
    ErrorSchema
...
class GameConfigCollectionView(PydanticView):
    ...
    async def post(self, game_config: GameToCreateSchema) -> Union[r201[ReturnedGameSchema], r409]:
        """
...
class GameConfigActionAddMemberView(PydanticView):
    ...
    async def put(
            self,
            name: str, /,
            team_member: TeamMemberToCreateSchema
